  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/favorites" className="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
          Ver todos
        </Link>
      </div>
      ...
      {userFavorites.length > 0 ? (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500">Você ainda não tem nenhum item favoritado.</p>
