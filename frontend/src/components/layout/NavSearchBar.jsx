      ...
      <div className="relative flex items-center">
        {isExpanded && (
          <div className="relative w-full">
            <input
              ...
              className="w-full px-4 py-1 rounded-full border border-gray-600 bg-gray-800 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
            />

            {/* Botão de fechar posicionado absolutamente */}
            {query && (
              <button
                onClick={() => {
                  setIsExpanded(false);
                ...
                className="absolute right-1 top-1/2 -translate-y-1/2 p-1 rounded-full hover:bg-gray-700 transition-colors"
                title="Fechar busca"
              >
        ...
        {!isExpanded && (
          <button
            ...
            className="p-2 rounded-full hover:bg-gray-700 transition-colors cursor-pointer ml-2"
            title="Buscar mídias"
          >
