  ...
  return (
    <AuthContainer title="Criar Conta" subtitle="Junte-se à nossa comunidade">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold py-4 rounded-lg transition-all duration-300 hover:from-blue-500 hover:to-blue-400 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-blue-500/20 flex items-center justify-center"
          disabled={loading}
        >
          {loading ? (
            <>
