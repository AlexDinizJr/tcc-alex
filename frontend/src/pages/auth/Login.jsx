    ...
    <>
      <AuthContainer title="Entrar" subtitle="Bem-vindo de volta!">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white font-semibold py-4 rounded-lg transition-all duration-300 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-blue-500/20 flex items-center justify-center"
            disabled={loading}
          >
            {loading ? (
              <>
